...
/// <summary>
/// Handler for text classification model predictions
/// </summary>
public class TextClassificationHandler : BaseMLHandler<TextClassificationPredictionResult>
{
    /// <summary>
    /// Perform text classification predictions on input data using model
    /// </summary>
    public override TextClassificationPredictionResult Predict(
        Assembly assembly,
        string inputPath,
        string className,
        ...
        string delimiter = ",")
    {
        ...
        return new TextClassificationPredictionResult(headers, [.. classes], items);
    }

    /// <summary>
    /// Save text classification prediction results to file
    /// </summary>
    public override void SaveResults(TextClassificationPredictionResult result, string outputPath)
    {

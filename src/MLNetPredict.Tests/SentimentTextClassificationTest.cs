namespace MLNetPredict.Tests
{
    public class SentimentTextClassificationTest
    {
        ...
        public SentimentTextClassificationTest()
        {
            ...
            // # pre requsites
            // mlnet text-classification --dataset ".\files\sentiment\yelp_labelled.txt" --has-header false --label-col 1 --text-col 0 --output "./models" --name "Sentiment" --log-file-path "./models/Sentiment/logs.txt"
        }
